...
#   ./scripts/parallel-tests.sh --emulator-args "--serial emulator-5554"
#   ./scripts/parallel-tests.sh --force-unit --emulator-args "--class ai.dcar.caldatewidget.ExampleTest"
#
...
Examples:
  ...
  $(basename "$0") --emulator-args "--serial emulator-5554"
  $(basename "$0") --force-unit --emulator-args "--class ai.dcar.caldatewidget.ExampleTest"
EOF
}
